...
window.Icon = (function () {
    const PATHS = {
        ...
        users: '<circle cx="9" cy="8.5" r="3.2"/><path d="M3 19.5c.9-3.1 3.3-4.8 6-4.8s5.1 1.7 6 4.8"/><path d="M15.5 5.6a3.1 3.1 0 0 1 0 6M17.4 14.9c1.8.6 3.1 2.1 3.6 4.6"/>',
        award: '<circle cx="12" cy="9" r="5.5"/><path d="m8.6 13.4-1.4 7.1L12 18l4.8 2.5-1.4-7.1"/><path d="m10 9 1.4 1.4L14.2 7.6"/>',
        book: '<path d="M12 6.5C10.3 5.2 8 4.5 4 4.5v13c4 0 6.3.7 8 2 1.7-1.3 4-2 8-2v-13c-4 0-6.3.7-8 2Z"/><path d="M12 6.5v13"/>',
        play: '<circle cx="12" cy="12" r="8.5"/><path d="m10.2 8.8 5 3.2-5 3.2V8.8Z"/>',
        hand: '<path d="M8 12.5V6a1.5 1.5 0 0 1 3 0v5.5M11 11V4.8a1.5 1.5 0 0 1 3 0V11M14 11V6.2a1.5 1.5 0 0 1 3 0v7.3c0 4-2.6 7-6.3 7-2.3 0-3.7-1-5-2.8L3.6 14a1.5 1.5 0 0 1 2.4-1.8L8 14.6"/>',
